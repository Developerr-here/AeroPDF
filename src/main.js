...
const TOOL_META = {
  ...
  'pdf-to-img': { title: 'PDF to PNG', desc: 'Extract pages from a PDF as separate PNG image downloads.', uploadHeadline: 'Upload one or more PDFs to convert to images', uploadSubline: 'or drag and drop them here', accepts: '.pdf', multiple: true },
